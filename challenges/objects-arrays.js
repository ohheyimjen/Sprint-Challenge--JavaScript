...
const tyrannosaurus = [diet: 'carnivorous' weight: '7000kg' length: '12m' period: 'Late Cretaceious',
roar: () => 'RAWERSRARARWERSARARARRRR!',];

const stegosaurus = [diet: 'herbivorous' weight: '2000kg' length: '9m' period: 'Late Jurassic'];

const velociraptor = [diet: 'carnivorous' weight: '15kg' length: '1.8m' period: 'Late Cretaceious'];
...
*/
let populationTotal = zooAnimals.reduce((totalPopulation, individualPopulation) => {
